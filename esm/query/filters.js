...
export function applyNestedCTEs(cte, docs, context) {
    if (!cte.ctes) {
        return;
    }
...
export function applyFilter(filter, doc, context) {
...
export function applyFiltersWithContext(docs, cte, context) {
    return applyFiltersInternal(docs, cte.filters, context);
}
export function applyFilters(docs, cte) {
