import { type Comment, commentsCollection } from "./collections/comments.js";
import { type Recipe, recipesCollection } from "./collections/recipes.js";
...
const sampleRecipes: Omit<Recipe, "id" | "createdAt" | "updatedAt">[] = [
	{
		...
		ingredients: [
			...
			{
				item: { name: "Eggs", description: "Large eggs" },
			...
			{
				item: { name: "Salt", description: "Fine salt" },
				quantity: { value: 5, unit: "g" },
			},
			{
				item: {
	...
	},
	{
		...
		ingredients: [
			...
			{
				item: { name: "Salt", description: "To taste" },
				quantity: { value: 5, unit: "g" },
			},
		],
		instructions: [
	...
	},
	{
		...
		ingredients: [
			...
			{
				item: { name: "Milk", description: "Whole milk" },
				quantity: { value: 300, unit: "ml" },
			},
			{
				item: { name: "Egg", description: "Large egg" },
				quantity: { value: 1, unit: "g" },
			},
			{
				item: { name: "Butter", description: "Melted butter" },
